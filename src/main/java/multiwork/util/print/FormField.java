package multiwork.util.print;

import multiwork.util.DateTools;
...
public class FormField {
  ...
  static private String formatTimestamp(Timestamp value,
    ...
    // quer a data?
    if (date)
      result = DateTools.dateToString(value);
    else if (hour)
      result = DateTools.timeToString(value);
    else if (date && hour)
      result = DateTools.dateTimeToString(value);
    // retorna
    return result;
  }
